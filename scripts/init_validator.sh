...
print_help()
{
	...
	printf 'Usage: %s [-l|--ledger-path <arg>] [--snapshots-path <arg>] [--accounts-path <arg>] [--log-level <arg>] [--ramdisk-size-gb <arg>] [--swap-file-size-gb <arg>] [--secrets-path <arg>] [--solana-user <arg>] [--solana-version <arg>] [--use-ramdisk-for-account <arg>] [-h|--help]\n' "$0"
...
init_validator () {
  ...
  ansible-playbook \
    --connection=local \
    --inventory ./playbooks/inventory/mainnet-beta.yaml \
